...
@stub.function()
@modal.web_endpoint(method="GET")
def free_var_search(term: str, sim_threshold=0.6, n=100, use_gpt=False):
...
def main():
    ...
    # )
    print(concept_descriptions["Disease_MESH_C563898"])
    free_var_search("Disease_MESH_C563898", use_gpt=True)
